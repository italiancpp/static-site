...
<p style="text-align: justify;">Consueto appuntamento dedicato alla programmazione e al miglioramento continuo ospitato dall'Associazione <a href="http://conoscerelinux.org" target="_blank" rel="noopener noreferrer">Conoscere Linux</a> di Modena e moderato da <em>Marco Arena</em>.</p>
...
<ul>
 	<li><a href="http://coding-gym.org">Qualche foto e l'elenco di tutte le serate</a></li>
</ul>
<strong>Cosa serve:</strong>
<ul>
 	<li style="text-align: justify;">tutto quello di cui hai bisogno è un computer con un browser ma non hai bisogno di portarlo perché la serata si tiene in una sala computer</li>
 	<li><strong>Risparmia tempo!</strong> Prima della serata iscriviti su:
<a href="https://www.hackerrank.com/modena-coding-jan-2018">https://www.hackerrank.com/modena-coding-dec-2017</a></li>
</ul>
<strong>Costo:</strong>
<ul>
...
<ul>
 	<li><a href="http://conoscerelinux.org/courses/coding-gym-jan18/">Iscriviti qui</a></li>
</ul>
